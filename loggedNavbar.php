<nav class="navbar navbar-toggleable-md navbar-light bg-faded fixed-top" style="height: 8vh; background-color: #eee;">
	...
	<div class="collapse navbar-collapse">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item">
				<a href="teachers.php" class="nav-link">Teachers</a>
			</li>
			<li class="nav-item">
