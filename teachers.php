				...
				<div class="mainContentContainer">
					...
					<div class="studentProfileContainer" id="studentProfileContainer">
						<div class="mainContent">
							...
							<div class="progressContainer">
								<p class="h6 progressTitle"><a href="mostRecentTest.php">Most Recent Test Average Score</a></p>					
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 35%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">35%</div>
								</div>
							</div>
							<div class="progressContainer">
								<p class="h6 progressTitle"><a href="mostRecentHomework.php">Most Recent Homework Average Score</a></p>					
								<div class="progress">
									<div class="progress-bar" role="progressbar" style="width: 95%" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">95%</div>
								</div>
							</div>
							<div class="progressContainer">
								<p class="h6 progressTitle">Academic Progress for Students</p>					
								<div class="progress">
